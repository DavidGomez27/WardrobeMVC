...
namespace WardrobeMVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,Name,Photo,Type,ColorID,OccasionID,SeasonID")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Name,Photo,Type,ColorID,OccasionID,SeasonID")] Top top)
        {
            if (ModelState.IsValid)
            {
