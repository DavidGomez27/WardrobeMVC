...
namespace WardrobeMVC.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoriesID,Name,Photo,Type,ColorID,OccasionID,SeasonID")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoriesID,Name,Photo,Type,ColorID,OccasionID,SeasonID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
